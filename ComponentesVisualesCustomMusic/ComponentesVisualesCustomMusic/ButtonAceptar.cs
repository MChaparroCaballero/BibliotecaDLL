...
namespace ComponentesVisualesCustomMusic
{
    ...
    //----------------------------------------------------------------------------------------------------------------------//
    public class PanelFondo : PictureBox
    {
        Image image = Image.FromFile("C:\\Users\\mchap\\source\\repos\\ProyectoMusicCostum\\ComponentesVisualesCustomMusic\\ComponentesVisualesCustomMusic\\imagenes\\MusicIcon.png");
...

        {
            ...
            this.Image = Image.FromFile("C:\\Users\\mchap\\source\\repos\\ProyectoMusicCostum\\ComponentesVisualesCustomMusic\\ComponentesVisualesCustomMusic\\imagenes\\MusicIcon.png");
            this.BackgroundImageLayout = ImageLayout.Zoom;
        }
        [Category("RJ Code Advance")]
        [Browsable(true)]
        [EditorBrowsable(EditorBrowsableState.Always)]
        public BorderStyle MostrarBorde
        {
    ...
    public class titulo : TextBox
    {
        ...
        // Propiedad para cambiar el grosor del borde
        [Category("RJ Code Advance")]
        [Browsable(true)]
        public int BorderSize
        {
        ...
        // Propiedad para cambiar el radio de los bordes (redondeados)
        [Category("RJ Code Advance")]
        [Browsable(true)]
        public int BorderRadius
        {
